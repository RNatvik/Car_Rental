...
public class UserInput {
    ...
    public double getInputDouble(String messageToUser) {
        ...
        while (!valueFound) {
            if (this.scanner.hasNextInt()) {
                ...
                foundValue = Double.parseDouble(value);
                valueFound = true;
            } else {
                this.scanner.nextLine();
                System.out.println("Invalid input, must be integer or decimal number. Try again");
            }
        }
        return foundValue;
    }
