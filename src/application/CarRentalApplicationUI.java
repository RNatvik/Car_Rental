 ...
 * @version 1.0
 */
public class CarRentalApplicationUI {
    private static final String VERSION = "v3.0.5";

    private CarRentalApplication application;
            ...
            try {
                ...
                switch (menuSelection) {
                    case ADD_CAR_TO_REGISTER:
                        this.application.addCarToCarRegister();
                        break;

                    case MAKE_RESERVATION:
                        this.application.makeReservation();
                        break;

                    case LIST_RENTALS_BY_CAR:
                        this.application.listRentalsByCar();
                        break;

                    case LIST_ALL_CARS:
                        this.application.listAllCars();
                        break;

                    case LIST_ALL_RENTALS:
                        this.application.listAllRentals();
                        break;
